$(function(){
	...
	var pic = new picLayer(map);
	pic.addImage('min/002.jpg');
	pic.refreshImage('min/1.jpg');
	
	var imageList = ['min/1.jpg','min/2.jpg','min/3.jpg','min/4.jpg','min/5.jpg','min/6.jpg','min/7.jpg','min/8.jpg'];
	pic.startImageAnimate(true,imageList);
